...
/*
Спойлеры
Документация: https://www.notion.so/81a2a7877e084604866ce6eaf99365f8#c5cf495e61fc4718ab5c9bb37e2928e4
*/
export function spollers() {
   ...
   if (spollersArray.length > 0) {
      ...
      let mdQueriesArray = auxiliary.dataMediaQueries(
         spollersArray,
         "spollers"
      );
      ...
      function setSpollerAction(e) {
         ...
         if (el.closest("[data-spoller]")) {
            ...
            const oneSpoller = spollersBlock.hasAttribute("data-spollers-solo");
         ...
         document.addEventListener("click", function (e) {
            ...
            if (!el.closest("[data-spollers]")) {
               spollersClose.forEach((spollerClose) => {
                  ...
                  auxiliary._slideUp(
                     spollerClose.nextElementSibling,
                     spollerSpeed
                  );
               });
            }
